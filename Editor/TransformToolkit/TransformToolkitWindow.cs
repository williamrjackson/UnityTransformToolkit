...
{
    public class TransformToolkitWindow : EditorWindow
    {
        // --- Selection caching ---
        ...
        [MenuItem("Tools/Transform Toolkit")]
        public static void Open() => GetWindow<TransformToolkitWindow>("Transform Toolkit");
        ...
        {
            var w = GetWindow<TransformToolkitWindow>("Transform Toolkit");
            w.Show();
            w.Focus();
